...
export interface IBond {
    ...
    /**
     * Производный признак «надёжности» для одноимённого фильтра: рынок не закладывает
     * в бумагу стресс (доходность не выше ключевой ставки на спред, а без рассчитанного
     * YTM — цена не обвалена). Считается на клиенте из доходности, цены и ключевой
     * ставки — см. isReliableBond в utils/bondLabels; undefined — ставка ещё не
     * загрузилась (фильтр ничего не отсекает).
     */
    reliable?: boolean;
}
